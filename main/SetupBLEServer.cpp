...
String SetupBLEServer::setNameCoffeeMachine() {
...
void SetupBLEServer::start(const String& mac, std::function<void(const String&, const String&)> callback) {
    Serial.println("Start server");
    String nameMachine = SetupBLEServer::setNameCoffeeMachine();
    BLEDevice::init(nameMachine);
    ...
    String deviceInfo = serializeDeviceInfo(nameMachine, mac);
